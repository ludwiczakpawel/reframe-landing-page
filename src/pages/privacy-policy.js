  ...
  return (
    <div>
      <Helmet htmlAttributes={{ lang: "pl" }}>
        <title>Privacy Policy – Reframe Technologies</title>
      </Helmet>
      <Header />
      ...
      <main className="prose sm:prose-lg md:prose-lg lg:prose-xl px-4 py-8 sm:py-12 md:py-16 lg:py-24 w-full max-w-3xl">
        ...
        <ul>
          <li>
            ...
            <a href="https://www.reframetech.com">
              https://www.reframetech.com
            </a>
        ...
        <p>
          ...
          information depending on how you interact with Reframe Technologies,
        ...
        <p className="pl-4">
          <address>
            Reframe Technologies, Inc. <br />
            228 Park Ave S, PMB 20519 <br />
        ...
        <p>
          ...
          controller" of your personal information is Reframe Technologies,
          Inc.. Reframe Technologies, Inc. has appointed Reframe Technologies
